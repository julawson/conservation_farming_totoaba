...
params = c('alpha', 'beta', 'r', 'k', 'sigma', 'W_mid', 'W_low', 'W_high', 'avg_cost','W1', 'W2', 'age', 'gamma', 'v', 'i_r','c')
value = c(alpha, beta, r, k, catchability, W_qmid, W_qlow, W_qhigh, W_high, 
          W_lq_new[baseline_W_choice,'W1'], W_lq_new[baseline_W_choice, 'W2'], age, gamma, v, interest_rate, c)
...
units = c('USD', 'USD/metric ton of biomass', 'unitless',   'metric tons of biomass','% of biomass/vessel trip', 'USD vessel trip$^{-2}$',  'USD vessel trip$^{-2}$', 'USDvessel trip$^{-2}$', 'USD/vessel trip', 'USD/vessel trip', 'USD vessel trip$^{-2}$', 'Years', 'USD/metric ton of biomass', 'USD/metric ton of biomass', '%', 'USD/ metric ton of biomass')
