...
6. **Best case scenario** with cost parameter c=`r c` is a difference of `r round(dat_cournot$Harvest- dat_monop$Harvest,2)` ( tons) in *harvest* or, equivalently, of `r  round((dat_monop$Harvest-dat_cournot$Harvest)*1000/25.7,2)` adult totoabas
