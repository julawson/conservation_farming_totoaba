...
if(!file.exists(here('data', 'inputs', 'params_sensitivity_lq.csv'))){
  ...
  colnames(new_params_sensitivity) = c(colnames(params_sensitivity), 'W1', 'W2')
...
**Price results** : our price results are ok in the *retail* case. However, they are not as good in the price paid to poachers. We could use the high value of the cost parameter $W$ to ensure that prices match observed trends. 
