...
profit = function(param){
  ...
  colnames(result) = c('row_', 'names','poached_harvest', 'farmed_harvest', 'price_poachers', 'profit_poaching', 'profit_farming', 'profit_fishermen','stability')
  return(result)
}
...
a%>%
  ...
  rename('Scenario' = names, 
         'Steady state population' = x,
         'Poached harvest' = poached_harvest,
         'Farmed harvest' = farmed_harvest,
         'Variation in ss. pop.' = normalized_ss,
         'Price  paid to poacher' = price_poachers,
         'Illegal profit'= profit_poaching,
         'Farming profit' = profit_farming, 
         'Fishing profit' = profit_fishermen,
         "Aggregate profit" = ag_profit,
         'Farming profit change' = profit_farming_diff,
         'Aggregate profit change' = ag_profit_diff, 
         'Fishing profit change' = profit_fishermen_diff,
         'Illegal profit change' = profit_poaching_diff,
  ...
  style_tt(j =5:9, background = '#d5f8c8' )%>%
  style_tt(j = 14:16, background = '#f4cccc')%>%
