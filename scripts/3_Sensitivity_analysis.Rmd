...
checker = store %>% 
  ...
  mutate(names = sapply(names, output3), 
         ...
         gamma = round(gamma/calibration$value[which(calibration$params=='gamma')],2)*100,
