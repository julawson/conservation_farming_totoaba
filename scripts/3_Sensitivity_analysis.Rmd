...
ggsave(here('visuals', 'Figure5c.jpg'))
#  geom_point(data = new_c, col = 'grey')
#  geom_point(data = new_v, col = 'blue')
```
...
pal = c("mediumseagreen", "black", 'gold1', 'darkorange','orangered', 'firebrick3', 'brown')
...
checker %>%
  ...
  theme(axis.text.x = element_text(angle = 60,
        ...
        legend.title = element_text(family = font_), 
        aspect.ratio = 10/4)
ggsave(here('visuals/supplementary_visuals', 'sens_alpha_gamma_normalized.jpg'), height = 11)
