...
data2$order2 = factor(paste0(data2$name3, data2$name2), c(paste0(levels(data2$name3), '1 trader'),
                                                          paste0(levels(data2$name3), '2 traders'),
                                                          paste0(levels(data2$name3), '5 traders'),
                                                          paste0(levels(data2$name3), '10 traders'),
                                                          paste0(levels(data2$name3), '50 traders')))
...
data2 %>%
  ...
  geom_hline(yintercept =monopoly_ss, 
             linetype = "dashed")+
  #scale_x_discrete(limits = levels(data$name))+
  scale_x_discrete(breaks=data2$order2, labels=data2$name3)+
